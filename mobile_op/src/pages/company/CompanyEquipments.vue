<template>
	<q-page class="bg-white">
        ...
        <div class="q-pa-md">
			...
			<q-card v-for="machine in machine_list" :key="machine.id" class="card-style q-pa-sm q-mb-md">
                ...
                <div class="text-left q-pa-sm text-caption">
                    <p class="text-primary no-margin text-truncate">Categoria: </p>
					<p class="text-primary no-margin text-truncate">Peso Máximo: </p>
					<p class="text-primary no-margin text-truncate">Raio: </p>
					<p class="text-primary no-margin text-truncate">Altura Máxima: </p>
                </div>
            </q-card>
        </div>
	</q-page>  
