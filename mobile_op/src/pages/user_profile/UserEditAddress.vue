<template>
    <q-page class="bg-white">
      <div class="row justify-around items-center q-pa-md q-mt-lg">
        ...
        <div class="flex column">
          ...
          <q-btn label="Atualizar"  @click="update_user_address" color="secondary" />
        </div>
        </q-form>
      </div>
      </q-page>
  ...
  <script>
    export default {
        ...
        this.get_user_address_by_logged();
        ...
        async get_user_address_by_logged() {
            ...
            .then(data => {
                ...
                this.complement=data.user_address[0].complement;
                this.neighborhood=data.user_address[0].neighborhood;
                this.city_name=data.user_address[0].city_name;
                this.state_name=data.user_address[0].state_name;
                this.number_street=data.user_address[0].number_street;
                this.zip_code=data.user_address[0].zip_code;
                this.street=data.user_address[0].street;
            })
            .catch(error => {
