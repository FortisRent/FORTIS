  ...
  <q-page class="bg-white">
    ...
    <div class="q-pa-md">
      <q-form @submit.prevent="create_employee" class="q-gutter-md q-pa-md">
        ...
        <!-- CPF aparece sempre que houver cargo selecionado -->
        <q-input
          v-if="selected_role"
          rounded
          color="secondary"
        ...
        <!-- CTPS Number aparece para todos -->
        <q-input
          v-if="selected_role"
          rounded
          color="secondary"
        ...
        <!-- Salário só para Consultor Técnico e Financeiro -->
        <q-input
        ...
        <!-- Demais campos só para cargos diferentes de Consultor Técnico e Financeiro -->
        <q-input
          v-if="selected_role && selected_role.name !== 'Consultor Técnico' && selected_role.name !== 'Financeiro'"
          rounded
          color="secondary"
        ...
        <q-input
          ...
          label="Quantidade mínima de horas"
          unmasked-value
          no-error-icon
        />
        <q-input
