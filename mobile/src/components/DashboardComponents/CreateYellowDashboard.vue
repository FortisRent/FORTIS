<template>
  <q-page>
    ...
    <div>
            ...
            >
              ...
              <q-card>
                <q-card-section>
                  <!-- TAMANHO ESCAVADEIRA -->
                  <div
                    v-if="category.category_name === 'Escavadeira'"
                    class="q-mt-md"
                  >
                    <p
                      class="text-bold text-primary text-subtitle1"
                      style="margin: 0"
                    >
                      Tamanho
                    </p>
                  ...
                  <div
                    v-if="category.category_name === 'Retroescavadeira'"
                    class="q-mt-md"
                  >
                    <p
                      class="text-bold text-primary text-subtitle1"
      ...
      <span v-else class="text-primary text-subtitle1 text-bold q-ml-md"
        >Descrever metro cubico (m³)</span
      >
