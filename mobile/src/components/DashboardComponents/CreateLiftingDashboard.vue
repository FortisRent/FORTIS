    ...
    <div>
      ...
      <div v-for="(selection, index) in machine_selections" :key="selection.id">
        ...
        <div class="q-pa-md" v-if="selection.category_list.length">
          <span class="text-primary text-bold text-subtitle1"
            >Selecione uma ou mais máquinas por Projeto*</span
          >
          <q-list bordered separator>
            <q-expansion-item
              v-for="category in selection.category_list"
              :key="category.uuid"
              v-model="expandedItems[category.uuid]"
              class="q-mb-sm"
              ...
              <template v-slot:header>
                ...
                <q-item-section>
                  <div class="row items-center">
                    <q-img
                      :src="getMachineImage(category.category_name)"
                      width="80px"
                      class="q-mr-md"
                    />
                    <span
              ...
              <q-card>
                <q-card-section>
                  ...
                  >
                    <q-input
                      label="JIB (m)"
                      v-model="jib_TreliçadoEsteira"
                      type="number"
                    />
                    <q-input
                      label="Peso Máximo (kg / tn)"
                      v-model="max_weight_TreliçadoEsteira"
                      type="number"
                    />
                    <q-input
                      label="Altura Máxima (m)"
                      v-model="max_height_TreliçadoEsteira"
                      type="number"
                    />
                    <q-input
                      label="Raio Máximo (m)"
                      v-model="max_radius_TreliçadoEsteira"
                      type="number"
                    />
                    ...
                    <q-input
                      ...
                      v-model="maximum_reach_without_jib_TreliçadoEsteira"
                      type="number"
                    />
                    <q-input
                      label="Alcance máximo vertical (m)"
                      v-model="maximum_vertical_reach_TreliçadoEsteira"
                      type="number"
                    />
                    <q-input
                      label="Alcance máximo horizontal (m)"
                      v-model="maximum_horizontal_reach_TreliçadoEsteira"
                      type="number"
                    />
                  </div>
                  ...
                  >
                    <q-input
                      label="JIB (m)"
                      v-model="jib_TreliçadoRoda"
                      type="number"
                    />
                    <q-input
                      label="Peso Máximo (kg / tn)"
                      v-model="max_weight_TreliçadoRoda"
                      type="number"
                    />
                    <q-input
                      label="Altura Máxima (m)"
                      v-model="max_height_TreliçadoRoda"
                      type="number"
                    />
                    <q-input
                      label="Raio Máximo (m)"
                      v-model="max_radius_TreliçadoRoda"
                      type="number"
                    />

                    <q-input
                      label="Capacidade máxima nomimal de elevação (Kg / tn)"
                      v-model="maximum_nominal_lifting_capacity_TreliçadoRoda"
                      type="number"
                    />
                    <q-input
                      label="Capacidade máxima nomimal de alcance vertical (m)"
                    ...
                    <q-input
                      label="Alcance máximo sem JIB (m)"
                      v-model="maximum_reach_without_jib_TreliçadoRoda"
                      type="number"
                    />
                    <q-input
                      label="Alcance máximo vertical (m)"
                      v-model="maximum_vertical_reach_TreliçadoRoda"
                      type="number"
                    />
                    <q-input
                      label="Alcance máximo horizontal (m)"
                      v-model="maximum_horizontal_reach_TreliçadoRoda"
                      type="number"
                    />
                  </div>
                  ...
                  >
                    <q-input
                      label="JIB (m)"
                      v-model="jib_TelescopicoEsteira"
                      type="number"
                    />
                    <q-input
                      label="Peso Máximo (kg / tn)"
                      v-model="max_weight_TelescopicoEsteira"
                      type="number"
                    />
                    <q-input
                      label="Altura Máxima (m)"
                      v-model="max_height_TelescopicoEsteira"
                      type="number"
                    />
                    <q-input
                      label="Raio Máximo (m)"
                      v-model="max_radius_TelescopicoEsteira"
                      type="number"
                    />
                    ...
                    <q-input
                      label="Alcance máximo sem JIB (m)"
                      v-model="maximum_reach_without_jib_TelescopicoEsteira"
                      type="number"
                    />
                    <q-input
                      label="Alcance máximo vertical (m)"
                      v-model="maximum_vertical_reach_TelescopicoEsteira"
                      type="number"
                    />
                    <q-input
                      label="Alcance máximo horizontal (m)"
                      v-model="maximum_horizontal_reach_TelescopicoEsteira"
                      type="number"
                    />
                  </div>
                  ...
                  >
                    <q-input
                      label="JIB (m)"
                      v-model="jib_TelescopicoRT"
                      type="number"
                    />
                    <q-input
                      label="Peso Máximo (kg / tn)"
                      v-model="max_weight_TelescopicoRT"
                      type="number"
                    />
                    <q-input
                      label="Altura Máxima (m)"
                      v-model="max_height_TelescopicoRT"
                      type="number"
                    />
                    <q-input
                      label="Raio Máximo (m)"
                      v-model="max_radius_TelescopicoRT"
                      type="number"
                    />

                    <q-input
                      label="Capacidade máxima nomimal de elevação (Kg / tn)"
                      v-model="maximum_nominal_lifting_capacity_TelescopicoRT"
                      type="number"
                    />
                    <q-input
                      label="Capacidade máxima nomimal de alcance vertical (m)"
                    ...
                    <q-input
                      label="Alcance máximo sem JIB (m)"
                      v-model="maximum_reach_without_jib_TelescopicoRT"
                      type="number"
                    />
                    <q-input
                      label="Alcance máximo vertical (m)"
                      v-model="maximum_vertical_reach_TelescopicoRT"
                      type="number"
                    />
                    <q-input
                      label="Alcance máximo horizontal (m)"
                      v-model="maximum_horizontal_reach_TelescopicoRT"
                      type="number"
                    />
                  </div>
                  ...
                  >
                    <q-input
                      label="JIB (m)"
                      v-model="jib_TelescopicoAT"
                      type="number"
                    />
                    <q-input
                      label="Peso Máximo (kg / tn)"
                      v-model="max_weight_TelescopicoAT"
                      type="number"
                    />
                    <q-input
                      label="Altura Máxima (m)"
                      v-model="max_height_TelescopicoAT"
                      type="number"
                    />
                    <q-input
                      label="Raio Máximo (m)"
                      v-model="max_radius_TelescopicoAT"
                      type="number"
                    />

                    <q-input
                      label="Capacidade máxima nomimal de elevação (Kg / tn)"
                      v-model="maximum_nominal_lifting_capacity_TelescopicoAT"
                      type="number"
                    />
                    <q-input
                      label="Capacidade máxima nomimal de alcance vertical (m)"
                    ...
                    <q-input
                      label="Alcance máximo sem JIB (m)"
                      v-model="maximum_reach_without_jib_TelescopicoAT"
                      type="number"
                    />
                    <q-input
                      label="Alcance máximo vertical (m)"
                      v-model="maximum_vertical_reach_TelescopicoAT"
                      type="number"
                    />
                    <q-input
                      label="Alcance máximo horizontal (m)"
                      v-model="maximum_horizontal_reach_TelescopicoAT"
                      type="number"
                    />
                  </div>
                  ...
                  >
                    <q-input
                      label="JIB (m)"
                      v-model="jib_TelescopicoCaminhaoCarroceria"
                      type="number"
                    />
                    <q-input
                      label="Peso Máximo (kg / tn)"
                      v-model="max_weight_TelescopicoCaminhaoCarroceria"
                      type="number"
                    />
                    <q-input
                      label="Altura Máxima (m)"
                      v-model="max_height_TelescopicoCaminhaoCarroceria"
                      type="number"
                    />
                    <q-input
                      label="Raio Máximo (m)"
                      v-model="max_radius_TelescopicoCaminhaoCarroceria"
                      type="number"
                    />
                  ...
                  >
                    <q-input
                      label="JIB (m)"
                      v-model="jib_TelescopicoCavaloTrator"
                      type="number"
                    />
                    <q-input
                      label="Peso Máximo (kg / tn)"
                      v-model="max_weight_TelescopicoCavaloTrator"
                      type="number"
                    />
                    <q-input
                      label="Altura Máxima (m)"
                      v-model="max_height_TelescopicoCavaloTrator"
                      type="number"
                    />
                    <q-input
                      label="Raio Máximo (m)"
                      v-model="max_radius_TelescopicoCavaloTrator"
                      type="number"
                    />
                    ...
                    <q-input
                      label="Alcance máximo vertical (m)"
                      v-model="maximum_vertical_reach_TelescopicoCavaloTrator"
                      type="number"
                    />
                    <q-input
                      label="Alcance máximo horizontal (m)"
                      v-model="maximum_horizontal_reach_TelescopicoCavaloTrator"
                      type="number"
                    />
                  </div>
                  ...
                  >
                    <q-input
                      label="JIB (m)"
                      v-model="jib_TelescopicoCavaloTratorCarreta"
                      type="number"
                    />
                    <q-input
                      label="Peso Máximo (kg / tn)"
                      v-model="max_weight_TelescopicoCavaloTratorCarreta"
                      type="number"
                    />
                    <q-input
                      label="Altura Máxima (m)"
                      v-model="max_height_TelescopicoCavaloTratorCarreta"
                      type="number"
                    />
                    <q-input
                      label="Raio Máximo (m)"
                      v-model="max_radius_TelescopicoCavaloTratorCarreta"
                      type="number"
                    />
                  ...
                  <div
                    class="q-mt-md"
                    v-if="selection.selected_machines.includes(category.uuid)"
                  >
                    <span class="text-primary text-bold"
                      >Precisa de Operador?</span
                    >
                    <q-checkbox
      ...
      <span v-else class="text-primary text-bold q-ml-md text-subtitle1"
        >Descreva o Serviço*</span
      >
...
export default {
  ...
  methods: {
    ...
    on_submit() {
      ...
      fetch(`https://fortis-api.55technology.com/v1/project/client/`, {
        method: 'POST',
        headers: {
        ...
        body: JSON.stringify({
          ...
          machine_list,
          client_uuid: this.selectedClient,
        }),
      })
        .then((response) => response.json())
        .then((data) => {
          this.$q.notify({
           ...
           if (data.project_uuid)
            this.$router.push(`/dashboard/select/machine/project/${data.project_uuid}`);
        })
        .catch(() => {
          this.$q.notify({
            color: 'red-4',
          ...
          async get_client_company() {
      fetch(
        `https://fortis-api.55technology.com/v1/client/company/${this.company_uuid}`,
        {
          method: 'GET',
          headers: { token: localStorage.getItem('access_token') },
        }
