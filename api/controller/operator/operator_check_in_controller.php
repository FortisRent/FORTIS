<?php
	...
	class OperatorCheckInController {
		...
		public function create_operator_check_in() {
			...
			try {
				...
				$query2 = "INSERT INTO operator_check_in (machine_operator_id, description)
				...
				if (!$stmt2->execute()) {
					throw new Exception("Erro ao adicionar checkin do funcionário.");
				}
				
				$this->mysqli->commit();
				http_response_code(200);
				echo json_encode(["message" => "Checkin feito com sucesso."]);
